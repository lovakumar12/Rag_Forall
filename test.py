...
#         print("\nOptions:")
#         print("1. Ingest documents from directory")
#         print("2. Run benchmark (5 test queries)")
#         print("3. Interactive Q&A")
#         print("4. Exit")
...
#                 try:
#                     rag.ingest_documents(directory)
#                 except Exception as e:
#                     print(f"❌ Error: {e}")
#             else:
...
if __name__ == "__main__":
    ...
    try:
        ...
        print("   pip install sentence-transformers faiss-cpu groq langchain-community pypdf pymupdf")
        sys.exit(1)
